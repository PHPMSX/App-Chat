...
import static com.example.socialnextwork.R.id.activity_main_drawer;
...
public class Profile extends AppCompatActivity{
    ...
    TextView name, email;
    TextView info, messageWait, friendRequest,
    blockList, logout, totalMessageWait,
    totalFriendRequest, totalBlockList;
    ...
    private void initNavigationView() {
        ...
        // header
        avatar = findViewById(R.id.navigation_view_avatar);
        name = findViewById(R.id.navigation_view_name);
        email = findViewById(R.id.navigation_view_email);

        // body
        info = findViewById(R.id.info);

        blockList = findViewById(R.id.block_list);
        totalBlockList = findViewById(R.id.total_block_list);

        messageWait = findViewById(R.id.message_wait);
        totalMessageWait = findViewById(R.id.total_message_wait);

        friendRequest = findViewById(R.id.friend_request);
        totalFriendRequest = findViewById(R.id.total_friend_request);

        logout = findViewById(R.id.logout);



        drawerLayout = findViewById(activity_main_drawer);
    ...
    private void eventInNavigationView() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(getApplicationContext()).load(image)
                        .placeholder(R.drawable.avatar_default).into(avatar);
            }
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Profile.this, "show info", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                    num = String.valueOf(dataSnapshot.getChildrenCount());
                totalMessageWait.setText(num);
            }
        ...
        // click
        messageWait.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intentMessageWait = new Intent(getApplicationContext(),
                        MessWait.class);
        ...
        // get total friend request

        reference = FirebaseDatabase.getInstance().getReference("Users")
                .child(fUser.getUid()).child("FriendRequest");
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                    num = String.valueOf(dataSnapshot.getChildrenCount());
                totalFriendRequest.setText(num);
            }
        ...
        friendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intentFriendRequest = new Intent(getApplicationContext(),
        ...
        // get total block list

        reference = FirebaseDatabase.getInstance().getReference("Users")
                .child(fUser.getUid()).child("BlockList");
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()) {
                        ...
                        case R.id.nav_friend_list:
                            ...
                            actionBar.setTitle("Friend"); // change actionbar title
